class RefreshWeekPopularThreadsJob < ApplicationJob
  queue_as :default

  def perform
    threads = DiscussionThreadQuery.new.weekPopular
    ...
    Rails.cache.write("week_popular_threads", json, expires_in: 180.minutes)
  end
end
